function GUIfMRIGraphAnalysisWUViewComp(fig_group,ga,bg)
...
set(ui_list_gr,'Position',[.02 .02 .30 .72])
...
%% Callback functions
    ...
    function update_measure_data()
        ...
        if isempty(measures)
            ...
            p1 = measures{1}.getProp(fMRIComparisonWU.PVALUE1);
            p2 = measures{1}.getProp(fMRIComparisonWU.PVALUE2);
