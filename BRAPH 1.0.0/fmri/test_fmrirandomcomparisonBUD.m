% File to test the use of fMRIRandomComparisonBUD.
%
...
n = fMRIRandomComparisonBUD( ...
    fMRIMeasureBUD.CODE,3, ...
    fMRIMeasureBUD.NOTES,'Random Comparison BUD', ...
    fMRIMeasureBUD.DENSITY,50)

%% hash, isMeasure, isComparison

[code,g,d] = n.hash();
bool1 = n.isMeasure();
bool2 = n.isComparison();

%% getDefaults

defaults = n.getDefaults();
