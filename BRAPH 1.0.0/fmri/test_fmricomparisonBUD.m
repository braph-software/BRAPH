% File to test the use of fMRIComparisonBUD.
%
...
comparison = fMRIComparisonBUD( ...
    fMRIComparisonBUD.CODE,1, ...
    fMRIComparisonBUD.NOTES,'Comparison BUD', ...
    fMRIComparisonBUD.DENSITY,20, ...
    fMRIComparisonBUD.GROUP1,1, ...
    fMRIComparisonBUD.GROUP2,2)
