...
%   threshold created from fMRI cohort.
%
% See also fMRIGraphAnalysisBUT, fMRICohort.
...
ga = fMRIGraphAnalysisBUT(cohort, Structure(), ...
    ...
    switch lower(MCF)
        ...
        case 'c'
            ...
            if Graph.isglobal(measurecode)
                ...
                disp(['p-value (1) = ' num2str(c.getProp(fMRIComparisonBUT.PVALUE1)) ])
                disp(['p-value (2) = ' num2str(c.getProp(fMRIComparisonBUT.PVALUE2)) ])
            ...
            if Graph.isnodal(measurecode)
                ...
                values = c.diff();
                p1 = c.getProp(fMRIComparisonBUT.PVALUE1);
                p2 = c.getProp(fMRIComparisonBUT.PVALUE2);
                ci = c.CI(5);
                ba = ga.getBrainAtlas();
