classdef fMRIRandomComparisonBUD < fMRIMeasureBUD
    % fMRIRandomComparisonBUD < fMRIMeasureBUD: Fixed density binary undirected fMRI random comparison
    %   fMRIRandomComparisonBUD represents fMRI comparison of binary undirected graph with fixed density
    %   with random graphs.
    %
    % fMRIRandomComparisonBUD properties (Access = protected):
    %   props   -   cell array of object properties < ListElement
    %
    % fMRIRandomComparisonBUD properties (Constants):
    ...
    %
    % fMRIRandomComparisonBUD methods:
    %   fMRIRandomComparisonBUD -   constructor
    ...
    %
    % fMRIRandomComparisonBUD methods (Static):
    ...
    %
    % See also fMRIMeasureBUD, fMRIRandomComparisonBUT, fMRIRandomComparisonWU.
    ...
    properties (Constant)
        ...
        RANDOM_COMP_VALUES = fMRIMeasureBUD.propnumber() + 1
        RANDOM_COMP_TAG = 'random graph values'
        RANDOM_COMP_FORMAT = BNC.NUMERIC
        RANDOM_COMP_DEFAULT = NaN
        
        % one-tailed p-value
        PVALUE1 = fMRIMeasureBUD.propnumber() + 2
        PVALUE1_TAG = 'pvalue1'
        PVALUE1_FORMAT = BNC.NUMERIC
        PVALUE1_DEFAULT = NaN
        
        % two-tailed p-value
        PVALUE2 = fMRIMeasureBUD.propnumber() + 3
        PVALUE2_TAG = 'pvalue2'
        PVALUE2_FORMAT = BNC.NUMERIC
        PVALUE2_DEFAULT = NaN
        
        % percentiles
        PERCENTILES = fMRIMeasureBUD.propnumber() + 4
    ...
    methods
        function n = fMRIRandomComparisonBUD(varargin)
            % FMRIRANDOMCOMPARISONBUD() creates binary undirected with fixed density fMRI comparisons with random graphs.
            %
            % FMRICOMPARISONBUD(Tag1,Value1,Tag2,Value2,...) initializes property Tag1 to Value1,
            %   Tag2 to Value2, ... .
            %   Admissible properties are:
            %       FMRIRandomComparisonBUD.CODE                -   numeric
            %       FMRIRandomComparisonBUD.PARAM               -   numeric
            %       FMRIRandomComparisonBUD.NOTES               -   char
            %       FMRIRandomComparisonBUD.GROUP1              -   numeric
            %       FMRIRandomComparisonBUD.VALUES1             -   numeric
            %       FMRIRandomComparisonBUD.DENSITY             -   numeric
            %       FMRIRandomComparisonBUD.THRESHOLD1          -   numeric
            %       FMRIRandomComparisonBUD.RANDOM_COMP_VALUES  -   numeric
            %       FMRIRandomComparisonBUD.PVALUE1             -   numeric
            %       FMRIRandomComparisonBUD.PVALUE2             -   numeric
            %       FMRIRandomComparisonBUD.PERCENTILES         -   numeric
            %
            % See also fMRIRandomComparisonBUD.

            n = n@fMRIMeasureBUD(varargin{:});
        end
        function d = diff(n)
            % DIFF difference between two measures
            %
        ...
        function ci = CI(n,p)
            ...
            p = round(p);
            percentiles = n.getProp(fMRIRandomComparisonBUD.PERCENTILES);
            if p==50
                ci = percentiles(51,:);
            elseif p>=0 && p<50
        ...
        function bool = isMeasure(n)
            ...
            %
            % See also fMRIRandomComparisonBUD, isComparison, isRandom.
        ...
        function bool = isComparison(n)
            ...
            %
            % See also fMRIRandomComparisonBUD, isMeasure, isRandom.
        ...
        function bool = isRandom(n)
            ...
            %
            % See also fMRIRandomComparisonBUD, isMeasure, isComparison.
    ...
    methods (Static)
        ...
        function tags = getTags()
            ...
            tags = [ fMRIMeasureBUD.getTags() ...
                fMRIRandomComparisonBUD.RANDOM_COMP_TAG ...
                fMRIRandomComparisonBUD.PVALUE1_TAG ...
                fMRIRandomComparisonBUD.PVALUE2_TAG ...
                fMRIRandomComparisonBUD.PERCENTILES_TAG];
        end
        function formats = getFormats()
            ...
            formats = [fMRIMeasureBUD.getFormats() ...
                fMRIRandomComparisonBUD.RANDOM_COMP_FORMAT ...
                fMRIRandomComparisonBUD.PVALUE1_FORMAT ...
                fMRIRandomComparisonBUD.PVALUE2_FORMAT ...
                fMRIRandomComparisonBUD.PERCENTILES_FORMAT];
        end
        function defaults = getDefaults()
            ...
            defaults = [fMRIMeasureBUD.getDefaults() ...
                fMRIRandomComparisonBUD.RANDOM_COMP_DEFAULT ...
                fMRIRandomComparisonBUD.PVALUE1_DEFAULT ...
                fMRIRandomComparisonBUD.PVALUE2_DEFAULT ...
                fMRIRandomComparisonBUD.PERCENTILES_DEFAULT];
        end
