function GUIfMRIGraphAnalysisBUT(ga)
%% fMRI Graph Analysis
...
%% General Constants
APPNAME = [GUI.fMGA_NAME ' BUT'];  % application name
BUILT = BNC.BUILT;
...
%% Application data
Check.isa('Error: The fMRI graph analysis ga must be a fMRIGraphAnalysisBUT',ga,'fMRIGraphAnalysisBUT')
selected_calc = [];
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = fMRIGraphAnalysisBUT(fMRICohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisBUTCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisBUTCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisBUTCalcRand(ga,mlist,selected_calc)
    end
...
init_matrix()
    ...
    function S = update_rearrange()
        ...
        graph = GraphBU(A,'structure',ga.getStructure(),'threshold',str2num(get(ui_edit_matrix_bt,'String')));
...
BRAINMEASURES_LABEL_THRESHOLD = 'threshold [%]';
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                if get(ui_checkbox_brainmeasures_groupavg,'Value')
                    value = mean(ms{i}.getProp(fMRIMeasureBUT.VALUES1));
                    density1 = mean(ms{i}.getProp(fMRIMeasureBUT.DENSITY1));
                else
                    value_temp = ms{i}.getProp(fMRIMeasureBUT.VALUES1);
                    value = value_temp(get(ui_popup_brainmeasures_subjects,'Value'));
                    
                    density_temp = ms{i}.getProp(fMRIMeasureBUT.DENSITY1);
                    density1 = density_temp(get(ui_popup_brainmeasures_subjects,'Value'));
                end
                ...
                data{i,BRAINMEASURES_MEAS_DENSITY_COL} = density1;
                data{i,BRAINMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(fMRIMeasureBUT.THRESHOLD);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(fMRIMeasureBUT.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(fMRIMeasureBUT.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(fMRIMeasureBUT.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(fMRIMeasureBUT.GROUP1);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cs{i}.getProp(fMRIComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cs{i}.getProp(fMRIComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cs{i}.getProp(fMRIComparisonBUT.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cs{i}.getProp(fMRIComparisonBUT.VALUES2);
                
                confint = cs{i}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                threshold = cs{i}.getProp(fMRIComparisonBUT.THRESHOLD);
                data{i,BRAINMEASURES_COMP_THRESHOLD_COL} = threshold;
                
                density1 = cs{i}.getProp(fMRIComparisonBUT.DENSITY1);
                density2 = cs{i}.getProp(fMRIComparisonBUT.DENSITY2);
                data{i,BRAINMEASURES_COMP_DENSITY1_COL} = mean(density1);
                data{i,BRAINMEASURES_COMP_DENSITY2_COL} = mean(density2);
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cs{i}.getProp(fMRIComparisonBUT.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(fMRIComparisonBUT.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cs{i}.getProp(fMRIComparisonBUT.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(fMRIComparisonBUT.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(fMRIComparisonBUT.GROUP2);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                ns{i}.getProp(fMRIRandomComparisonBUT.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.VALUES1);
                
                confint = ns{i}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                threshold = ns{i}.getProp(fMRIRandomComparisonBUT.THRESHOLD1);
                data{i,BRAINMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                density1 = ns{i}.getProp(fMRIRandomComparisonBUT.DENSITY);
                data{i,BRAINMEASURES_RAND_DENSITY_COL} = mean(density1);
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(fMRIRandomComparisonBUT.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.GROUP1);
            end
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                ...
                                meas(i) = value;
                                d(i) = ms{i}.getProp(fMRIMeasureBUT.THRESHOLD);
                            end
                ...
                elseif get(ui_checkbox_brainmeasures_comp,'Value')
                    ...
                    if ~isempty(ci)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(cs)
                                diff(i) = cs{i}.diff();
                                d(i) = cs{i}.getProp(fMRIMeasureBUT.THRESHOLD);
                                m(i) = cs{i}.CI(50);
                                ci5 = cs{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
                ...
                elseif get(ui_checkbox_brainmeasures_rand,'Value')
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                meas(i) = ns{i}.getProp(fMRIRandomComparisonBUT.RANDOM_COMP_VALUES);
                                d(i) = ns{i}.getProp(fMRIRandomComparisonBUT.THRESHOLD);
                                m(i) = ns{i}.CI(50);
                                ci5 = ns{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
...
init_regionmeasures()
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                value_tmp = ms{i}.getProp(fMRIMeasureBUT.VALUES1);
                value_tmp_br = value_tmp(:,bri);
                if get(ui_checkbox_regionmeasures_groupavg,'Value')
                    value = mean(value_tmp_br);
                    density = mean(ms{i}.getProp(fMRIMeasureBUT.DENSITY1));
                else
                    value = value_tmp_br(get(ui_popup_regionmeasures_subjects,'Value'));
                    
                    threshold_temp = ms{i}.getProp(fMRIMeasureBUT.DENSITY1);
                    density = threshold_temp(get(ui_popup_brainmeasures_subjects,'Value'));   
                end
                ...
                data{i,REGIONMEASURES_MEAS_DENSITY_COL} = density;
                data{i,REGIONMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(fMRIMeasureBUT.THRESHOLD);
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(fMRIMeasureBUT.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(fMRIMeasureBUT.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(fMRIMeasureBUT.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(fMRIMeasureBUT.PARAM);
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                density1 = cs{i}.getProp(fMRIComparisonBUT.DENSITY1);
                density2 = cs{i}.getProp(fMRIComparisonBUT.DENSITY2);
                data{i,REGIONMEASURES_COMP_DENSITY1_COL} = mean(density1);
                data{i,REGIONMEASURES_COMP_DENSITY2_COL} = mean(density2);
                
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cs{i}.getProp(fMRIComparisonBUT.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(fMRIComparisonBUT.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cs{i}.getProp(fMRIComparisonBUT.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(fMRIComparisonBUT.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(fMRIComparisonBUT.GROUP2);
        ...
        elseif get(ui_checkbox_regionmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                threshold = ns{i}.getProp(fMRIRandomComparisonBUT.THRESHOLD);
                data{i,REGIONMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                density = ns{i}.getProp(fMRIRandomComparisonBUT.DENSITY1);
                data{i,REGIONMEASURES_RAND_DENSITY_COL} = mean(density);
                
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(fMRIRandomComparisonBUT.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{i}.getProp(fMRIRandomComparisonBUT.GROUP1);
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                ...
                                temp = ns{i}.getProp(fMRIRandomComparisonBUT.RANDOM_COMP_VALUES);
                                meas(i) = temp(bri);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisBUTViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisBUTViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisBUTViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIfMRIGraphAnalysisBUTSetGraph(f,ga,bg)
    end
