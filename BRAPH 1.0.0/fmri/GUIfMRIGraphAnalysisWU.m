function GUIfMRIGraphAnalysisWU(ga)
%% fMRI Graph Analysis
...
%% General Constants
APPNAME = [GUI.fMGA_NAME ' WU'];  % application name
BUILT = BNC.BUILT;
...
%% Application data
Check.isa('Error: The fMRI graph analysis ga must be a fMRIGraphAnalysisWU',ga,'fMRIGraphAnalysisWU')
selected_calc = [];
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = fMRIGraphAnalysisWU(fMRICohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisWUCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisWUCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIfMRIGraphAnalysisWUCalcRand(ga,mlist,selected_calc)
    end
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(indices)
                    if get(ui_checkbox_brainmeasures_groupavg,'Value')
                        value = mean(ms{indices(i)}.getProp(fMRIMeasureWU.VALUES1));
                    else
                        value_temp = ms{indices(i)}.getProp(fMRIMeasureWU.VALUES1);
                    ...
                    data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.NOTES);
                    data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{indices(i)}.getProp(fMRIMeasureWU.CODE)};
                    data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.PARAM);
                    data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.GROUP1);
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(indices)
                    ...
                    data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.PVALUE1);
                    data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.PVALUE2);
                    data{i,BRAINMEASURES_COMP_VALUE1_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.VALUES1);
                    data{i,BRAINMEASURES_COMP_VALUE2_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.VALUES2);
                    
                    confint = cos{indices(i)}.CI(5);
                    data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                    data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                    
                    data{i,BRAINMEASURES_COMP_NOTES_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.NOTES);
                    data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cos{indices(i)}.getProp(fMRIComparisonWU.CODE)};
                    data{i,BRAINMEASURES_COMP_PARAM_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.PARAM);
                    data{i,BRAINMEASURES_COMP_GROUP1_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.GROUP1);
                    data{i,BRAINMEASURES_COMP_GROUP2_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.GROUP2);
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(indices)
                    ...
                    data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.RANDOM_COMP_VALUES);
                    data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PVALUE1);
                    data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PVALUE2);
                    data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.VALUES1);
                    
                    confint = ns{indices(i)}.CI(5);
                    data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                    data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                    
                    data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.NOTES);
                    data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{indices(i)}.getProp(fMRIRandomComparisonWU.CODE)};
                    data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PARAM);
                    data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.GROUP1);
...
init_regionmeasures()
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(indices)
                    value_tmp = ms{indices(i)}.getProp(fMRIMeasureWU.VALUES1);
                    ...
                    data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.NOTES);
                    data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{indices(i)}.getProp(fMRIMeasureWU.CODE)};
                    data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.GROUP1);
                    data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                    data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{indices(i)}.getProp(fMRIMeasureWU.PARAM);
                    RowName(i) = mi(indices(i));
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(indices)
                    ...
                    data{i,REGIONMEASURES_COMP_NOTES_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.NOTES);
                    data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cos{indices(i)}.getProp(fMRIComparisonWU.CODE)};
                    data{i,REGIONMEASURES_COMP_PARAM_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.PARAM);
                    data{i,REGIONMEASURES_COMP_GROUP1_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.GROUP1);
                    data{i,REGIONMEASURES_COMP_GROUP2_COL} = cos{indices(i)}.getProp(fMRIComparisonWU.GROUP2);
        ...
        elseif get(ui_checkbox_regionmeasures_rand,'Value')
            ...
            for i = 1:1:length(indices)
                    ...
                    val = ns{indices(i)}.getProp(fMRIRandomComparisonWU.RANDOM_COMP_VALUES);
                    data{i,REGIONMEASURES_RAND_COMPVALUE_COL} = val(bri);
                    
                    p1 = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PVALUE1);
                    data{i,REGIONMEASURES_RAND_PVALUE1_COL} = p1(bri);
                    data{i,REGIONMEASURES_RAND_FDR1_COL} = fdr(p1);
                    
                    p2 = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PVALUE2);
                    data{i,REGIONMEASURES_RAND_PVALUE2_COL} = p2(bri);
                    data{i,REGIONMEASURES_RAND_FDR2_COL} = fdr(p2);
                    
                    rval = ns{indices(i)}.getProp(fMRIRandomComparisonWU.VALUES1);
                    ...
                    data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.NOTES);
                    data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{indices(i)}.getProp(fMRIRandomComparisonWU.CODE)};
                    data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.PARAM);
                    data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{indices(i)}.getProp(fMRIRandomComparisonWU.GROUP1);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisWUViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisWUViewComp(fig_group,ga,bg)
        else
     ...
     function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIfMRIGraphAnalysisWUViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIfMRIGraphAnalysisWUSetGraph(f,ga,bg)
    end
