% File to test the use of fMRIComparisonWU.
%
...
%% create WU comparison

comparison = fMRIComparisonWU( ...
    fMRIComparisonWU.CODE,1, ...
    fMRIComparisonWU.NOTES,'Comparison WU', ...
    fMRIComparisonWU.GROUP1,1, ...
    fMRIComparisonWU.GROUP2,2)

%% diff, hash, isMeasure, isComparison

difference = comparison.diff();
[code,g1,g2] = comparison.hash();
