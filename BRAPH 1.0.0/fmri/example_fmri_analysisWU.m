...
%   from fMRI cohort.
%
% See also fMRIGraphAnalysisWU, fMRICohort.
    ...
    switch lower(MCF)
        ...
        case 'c'
            ...
            if Graph.isglobal(measurecode)
                ...
                disp(['p-value (1) = ' num2str(c.getProp(fMRIComparisonWU.PVALUE1)) ])
                disp(['p-value (2) = ' num2str(c.getProp(fMRIComparisonWU.PVALUE2)) ])
            ...
            if Graph.isnodal(measurecode)
                ...
                values = c.diff();
                p1 = c.getProp(fMRIComparisonWU.PVALUE1);
                p2 = c.getProp(fMRIComparisonWU.PVALUE2);
                ci = c.CI(5);
                ba = ga.getBrainAtlas();
