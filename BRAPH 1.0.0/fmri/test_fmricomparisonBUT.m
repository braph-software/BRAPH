% File to test the use of fMRIComparisonBUT.
%
...
%% create BUT comparison

comparison = fMRIComparisonBUT( ...
    fMRIComparisonBUT.CODE,1, ...
    fMRIComparisonBUT.NOTES,'Comparison BUT', ...
    fMRIComparisonBUT.THRESHOLD,0.5, ...
    fMRIComparisonBUT.GROUP1,1, ...
    fMRIComparisonBUT.GROUP2,2)

%% diff, hash, isMeasure, isComparison

difference = comparison.diff();
[code,g1,g2,d] = comparison.hash();
bool1 = comparison.isMeasure();
bool2 = comparison.isComparison();

%% getDefaults

defaults = comparison.getDefaults();
