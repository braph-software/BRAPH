% File to test the use of fMRIRandomComparisonBUT.
%
...
c = fMRIRandomComparisonBUT( ...
    fMRIMeasureBUT.CODE,3, ...
    fMRIMeasureBUT.NOTES,'Random Comparison BUT', ...
    fMRIMeasureBUT.THRESHOLD,0.5)

%% hash, isMeasure, isComparison

[code,g,d] = c.hash();
bool1 = c.isMeasure();
bool2 = c.isComparison();
