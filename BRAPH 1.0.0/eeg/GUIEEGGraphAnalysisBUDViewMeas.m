function GUIEEGGraphAnalysisBUDViewMeas(fig_group,ga,bg)
...
%% Callback functions
    ...
    function update_densities()
        ...
        if isempty(mi)
            ...
            for i = 1:1:length(ms)
                densities(i) = ms{i}.getProp(EEGMeasureBUD.DENSITY);
            end
    ...
    function update_measure_data()
        ...
        if strcmp(get(ui_list_denity,'String'),CALC_NOTIFICATION)
            ...
            if isempty(meas)
                ...
                measure_data_tmp = meas.getProp(EEGMeasureBUD.VALUES1);
