% File to test the use of EEGCohort.
%
% See also EEGCohort.
...
cohort = EEGCohort(atlas,subjects,EEGCohort.NAME,'cohort 1',EEGCohort.T,10);
...
cohort_loadxml = EEGCohort(atlas);
