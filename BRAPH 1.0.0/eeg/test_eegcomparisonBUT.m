% File to test the use of EEGComparisonBUT.
%
...
comparison = EEGComparisonBUT( ...
    EEGComparisonBUT.CODE,1, ...
    EEGComparisonBUT.NOTES,'Comparison BUT', ...
    EEGComparisonBUT.THRESHOLD,0.5, ...
    EEGComparisonBUT.GROUP1,1, ...
    EEGComparisonBUT.GROUP2,2)
