% File to test the use of EEGComparisonBUD.
%
...
comparison = EEGComparisonBUD( ...
    EEGComparisonBUD.CODE,1, ...
    EEGComparisonBUD.NOTES,'Comparison BUD', ...
    EEGComparisonBUD.DENSITY,20, ...
    EEGComparisonBUD.GROUP1,1, ...
    EEGComparisonBUD.GROUP2,2)
