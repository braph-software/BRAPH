% File to test the use of EEGComparisonWU.
%
...
comparison = EEGComparisonWU( ...
    EEGComparisonWU.CODE,1, ...
    EEGComparisonWU.NOTES,'Comparison WU', ...
    EEGComparisonWU.GROUP1,1, ...
    EEGComparisonWU.GROUP2,2)
