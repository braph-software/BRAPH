function GUIEEGGraphAnalysisBUD(ga)
%% EEG Graph Analysis
...
%% General Constants
APPNAME = [GUI.EGA_NAME ' BUD'];  % application name
BUILT = BNC.BUILT;
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = EEGGraphAnalysisBUD(EEGCohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUDCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUDCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUDCalcRand(ga,mlist,selected_calc)
    end
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                if get(ui_checkbox_brainmeasures_groupavg,'Value')
                    value = mean(ms{i}.getProp(EEGMeasureBUD.VALUES1));
                    threshold = mean(ms{i}.getProp(EEGMeasureBUD.THRESHOLD1));
                else
                    value_temp = ms{i}.getProp(EEGMeasureBUD.VALUES1);
                    value = value_temp(get(ui_popup_brainmeasures_subjects,'Value'));
                    
                    threshold_temp = ms{i}.getProp(EEGMeasureBUD.THRESHOLD1);
                ...
                data{i,BRAINMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(EEGMeasureBUD.DENSITY);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(EEGMeasureBUD.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(EEGMeasureBUD.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(EEGMeasureBUD.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(EEGMeasureBUD.GROUP1);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cs{i}.getProp(EEGComparisonBUD.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cs{i}.getProp(EEGComparisonBUD.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cs{i}.getProp(EEGComparisonBUD.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cs{i}.getProp(EEGComparisonBUD.VALUES2);
                
                confint = cs{i}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                density = cs{i}.getProp(EEGComparisonBUD.DENSITY);
                data{i,BRAINMEASURES_COMP_DENSITY_COL} = density;
                
                threshold1 = cs{i}.getProp(EEGComparisonBUD.THRESHOLD1);
                threshold2 = cs{i}.getProp(EEGComparisonBUD.THRESHOLD2);
                data{i,BRAINMEASURES_COMP_THRESHOLD1_COL} = mean(threshold1);
                data{i,BRAINMEASURES_COMP_THRESHOLD2_COL} = mean(threshold2);
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cs{i}.getProp(EEGComparisonBUD.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(EEGComparisonBUD.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cs{i}.getProp(EEGComparisonBUD.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(EEGComparisonBUD.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(EEGComparisonBUD.GROUP2);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                ns{i}.getProp(EEGRandomComparisonBUD.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{i}.getProp(EEGRandomComparisonBUD.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{i}.getProp(EEGRandomComparisonBUD.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{i}.getProp(EEGRandomComparisonBUD.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{i}.getProp(EEGRandomComparisonBUD.VALUES1);
                
                confint = ns{i}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                density = ns{i}.getProp(EEGRandomComparisonBUD.DENSITY);
                data{i,BRAINMEASURES_RAND_DENSITY_COL} = density;
                
                threshold = ns{i}.getProp(EEGRandomComparisonBUD.THRESHOLD1);
                data{i,BRAINMEASURES_RAND_THRESHOLD_COL} = mean(threshold);
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{i}.getProp(EEGRandomComparisonBUD.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(EEGRandomComparisonBUD.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{i}.getProp(EEGRandomComparisonBUD.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{i}.getProp(EEGRandomComparisonBUD.GROUP1);
            end
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                ...
                                meas(i) = value;
                                d(i) = ms{i}.getProp(EEGMeasureBUD.DENSITY);
                            end
                ...
                elseif get(ui_checkbox_brainmeasures_comp,'Value')
                    ...
                    if ~isempty(ci)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(cs)
                                diff(i) = cs{i}.diff();
                                d(i) = cs{i}.getProp(EEGMeasureBUD.DENSITY);
                                m(i) = cs{i}.CI(50);
                                ci5 = cs{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
                ...
                elseif get(ui_checkbox_brainmeasures_rand,'Value')
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                meas(i) = ns{i}.getProp(EEGRandomComparisonBUD.RANDOM_COMP_VALUES);
                                d(i) = ns{i}.getProp(EEGRandomComparisonBUD.DENSITY);
                                m(i) = ns{i}.CI(50);
                                ci5 = ns{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
...
init_regionmeasures()
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                value_tmp = ms{i}.getProp(EEGMeasureBUD.VALUES1);
                ...
                data{i,REGIONMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(EEGMeasureBUD.DENSITY);
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(EEGMeasureBUD.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(EEGMeasureBUD.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(EEGMeasureBUD.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(EEGMeasureBUD.PARAM);
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cs{i}.getProp(EEGComparisonBUD.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(EEGComparisonBUD.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cs{i}.getProp(EEGComparisonBUD.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(EEGComparisonBUD.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(EEGComparisonBUD.GROUP2);
        ...
        elseif get(ui_checkbox_regionmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{i}.getProp(EEGRandomComparisonBUD.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(EEGRandomComparisonBUD.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{i}.getProp(EEGRandomComparisonBUD.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{i}.getProp(EEGRandomComparisonBUD.GROUP1);
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                ...
                                temp = ns{i}.getProp(EEGRandomComparisonBUD.RANDOM_COMP_VALUES);
                                meas(i) = temp(bri);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUDViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUDViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUDViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIEEGGraphAnalysisBUDSetGraph(f,ga,bg)
    end
