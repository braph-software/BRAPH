% File to test the use of EEGGraphAnalysisBUT.
%
...
gaBUT = EEGGraphAnalysisBUT(cohort,Structure(), ...
...
n2 = gaBUT.randomcompare(Graph.DEGREEAV,2,0.10,'verbose',0);
n3 = gaBUT.randomcompare(Graph.DEGREEAV,2,0.30,'verbose',0);
