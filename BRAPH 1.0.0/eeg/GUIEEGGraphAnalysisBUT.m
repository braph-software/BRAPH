function GUIEEGGraphAnalysisBUT(ga)
%% EEG Graph Analysis
...
%% General Constants
APPNAME = [GUI.EGA_NAME ' BUT'];  % application name
BUILT = BNC.BUILT;
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = EEGGraphAnalysisBUT(EEGCohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUTCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUTCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIEEGGraphAnalysisBUTCalcRand(ga,mlist,selected_calc)
    end
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                if get(ui_checkbox_brainmeasures_groupavg,'Value')
                    value = mean(ms{i}.getProp(EEGMeasureBUT.VALUES1));
                    density1 = mean(ms{i}.getProp(EEGMeasureBUT.DENSITY1));
                else
                    value_temp = ms{i}.getProp(EEGMeasureBUT.VALUES1);
                    value = value_temp(get(ui_popup_brainmeasures_subjects,'Value'));
                    
                    density_temp = ms{i}.getProp(EEGMeasureBUT.DENSITY1);
                ...
                data{i,BRAINMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(EEGMeasureBUT.THRESHOLD);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(EEGMeasureBUT.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(EEGMeasureBUT.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(EEGMeasureBUT.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(EEGMeasureBUT.GROUP1);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cs{i}.getProp(EEGComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cs{i}.getProp(EEGComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cs{i}.getProp(EEGComparisonBUT.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cs{i}.getProp(EEGComparisonBUT.VALUES2);
                
                confint = cs{i}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                threshold = cs{i}.getProp(EEGComparisonBUT.THRESHOLD);
                data{i,BRAINMEASURES_COMP_THRESHOLD_COL} = threshold;
                
                density1 = cs{i}.getProp(EEGComparisonBUT.DENSITY1);
                density2 = cs{i}.getProp(EEGComparisonBUT.DENSITY2);
                data{i,BRAINMEASURES_COMP_DENSITY1_COL} = mean(density1);
                data{i,BRAINMEASURES_COMP_DENSITY2_COL} = mean(density2);
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cs{i}.getProp(EEGComparisonBUT.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(EEGComparisonBUT.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cs{i}.getProp(EEGComparisonBUT.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(EEGComparisonBUT.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(EEGComparisonBUT.GROUP2);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                ns{i}.getProp(EEGRandomComparisonBUT.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{i}.getProp(EEGRandomComparisonBUT.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{i}.getProp(EEGRandomComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{i}.getProp(EEGRandomComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{i}.getProp(EEGRandomComparisonBUT.VALUES1);
                
                confint = ns{i}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                threshold = ns{i}.getProp(EEGRandomComparisonBUT.THRESHOLD1);
                data{i,BRAINMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                density1 = ns{i}.getProp(EEGRandomComparisonBUT.DENSITY);
                data{i,BRAINMEASURES_RAND_DENSITY_COL} = mean(density1);
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{i}.getProp(EEGRandomComparisonBUT.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(EEGRandomComparisonBUT.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{i}.getProp(EEGRandomComparisonBUT.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{i}.getProp(EEGRandomComparisonBUT.GROUP1);
            end
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                ...
                                meas(i) = value;
                                d(i) = ms{i}.getProp(EEGMeasureBUT.THRESHOLD);
                            end
                ...
                elseif get(ui_checkbox_brainmeasures_comp,'Value')
                    ...
                    if ~isempty(ci)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(cs)
                                diff(i) = cs{i}.diff();
                                d(i) = cs{i}.getProp(EEGMeasureBUT.THRESHOLD);
                                m(i) = cs{i}.CI(50);
                                ci5 = cs{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
                ...
                elseif get(ui_checkbox_brainmeasures_rand,'Value')
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                meas(i) = ns{i}.getProp(EEGRandomComparisonBUT.RANDOM_COMP_VALUES);
                                d(i) = ns{i}.getProp(EEGRandomComparisonBUT.THRESHOLD);
                                m(i) = ns{i}.CI(50);
                                ci5 = ns{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                ...
                data{i,REGIONMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(EEGMeasureBUT.THRESHOLD);
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(EEGMeasureBUT.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(EEGMeasureBUT.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(EEGMeasureBUT.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(EEGMeasureBUT.PARAM);
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cs{i}.getProp(EEGComparisonBUT.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(EEGComparisonBUT.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cs{i}.getProp(EEGComparisonBUT.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(EEGComparisonBUT.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(EEGComparisonBUT.GROUP2);
        ...
        elseif get(ui_checkbox_regionmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                threshold = ns{i}.getProp(EEGRandomComparisonBUT.THRESHOLD);
                data{i,REGIONMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                density = ns{i}.getProp(EEGRandomComparisonBUT.DENSITY1);
                data{i,REGIONMEASURES_RAND_DENSITY_COL} = mean(density);
                
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{i}.getProp(EEGRandomComparisonBUT.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(EEGRandomComparisonBUT.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{i}.getProp(EEGRandomComparisonBUT.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{i}.getProp(EEGRandomComparisonBUT.GROUP1);
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                ...
                                temp = ns{i}.getProp(EEGRandomComparisonBUT.RANDOM_COMP_VALUES);
                                meas(i) = temp(bri);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUTViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUTViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIEEGGraphAnalysisBUTViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIEEGGraphAnalysisBUTSetGraph(f,ga,bg)
    end
