function GUIMRIGraphAnalysisBUD(ga)
%% MRI Graph Analysis
...
%% General Constants
APPNAME = [GUI.MGA_NAME ' BUD'];  % application name
BUILT = BNC.BUILT;
...
%% Application data
Check.isa('Error: The MRI graph analysis ga must be a MRIGraphAnalysisBUD',ga,'MRIGraphAnalysisBUD')
selected_calc = [];
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = MRIGraphAnalysisBUD(MRICohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIMRIGraphAnalysisBUDCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIMRIGraphAnalysisBUDCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIMRIGraphAnalysisBUDCalcRand(ga,mlist,selected_calc)
    end
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                ...
                data{i,BRAINMEASURES_MEAS_VALUE_COL} = ms{i}.getProp(MRIMeasureBUD.VALUES1);
                data{i,BRAINMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(MRIMeasureBUD.THRESHOLD1);
                data{i,BRAINMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(MRIMeasureBUD.DENSITY);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(MRIMeasureBUD.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(MRIMeasureBUD.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(MRIMeasureBUD.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(MRIMeasureBUD.GROUP1);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cs{i}.getProp(MRIComparisonBUD.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cs{i}.getProp(MRIComparisonBUD.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cs{i}.getProp(MRIComparisonBUD.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cs{i}.getProp(MRIComparisonBUD.VALUES2);
                
                confint = cs{i}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                density = cs{i}.getProp(MRIComparisonBUD.DENSITY);
                data{i,BRAINMEASURES_COMP_DENSITY_COL} = density;
                
                threshold1 = cs{i}.getProp(MRIComparisonBUD.THRESHOLD1);
                threshold2 = cs{i}.getProp(MRIComparisonBUD.THRESHOLD2);
                data{i,BRAINMEASURES_COMP_THRESHOLD1_COL} = threshold1;
                data{i,BRAINMEASURES_COMP_THRESHOLD2_COL} = threshold2;
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cs{i}.getProp(MRIComparisonBUD.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(MRIComparisonBUD.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cs{i}.getProp(MRIComparisonBUD.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(MRIComparisonBUD.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(MRIComparisonBUD.GROUP2);
            end
            set(ui_table_brainmeasures,'Data',data)
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{i}.getProp(MRIRandomComparisonBUD.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{i}.getProp(MRIRandomComparisonBUD.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{i}.getProp(MRIRandomComparisonBUD.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{i}.getProp(MRIRandomComparisonBUD.VALUES1);
                
                confint = ns{i}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                density = ns{i}.getProp(MRIRandomComparisonBUD.DENSITY);
                data{i,BRAINMEASURES_RAND_DENSITY_COL} = density;
                
                threshold = ns{i}.getProp(MRIRandomComparisonBUD.THRESHOLD1);
                data{i,BRAINMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{i}.getProp(MRIRandomComparisonBUD.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(MRIRandomComparisonBUD.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{i}.getProp(MRIRandomComparisonBUD.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{i}.getProp(MRIRandomComparisonBUD.GROUP1);
            end
                ...
                if get(ui_checkbox_brainmeasures_meas,'Value')
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                meas(i) = ms{i}.getProp(MRIMeasureBUD.VALUES1);
                                d(i) = ms{i}.getProp(MRIMeasureBUD.DENSITY);
                            end
                ...
                elseif get(ui_checkbox_brainmeasures_comp,'Value')
                    ...
                    if ~isempty(ci)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(cs)
                                diff(i) = cs{i}.diff();
                                d(i) = cs{i}.getProp(MRIMeasureBUD.DENSITY);
                                m(i) = cs{i}.CI(50);
                                ci5 = cs{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
                ...
                elseif get(ui_checkbox_brainmeasures_rand,'Value')
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                meas(i) = ns{i}.getProp(MRIRandomComparisonBUD.RANDOM_COMP_VALUES);
                                d(i) = ns{i}.getProp(MRIRandomComparisonBUD.DENSITY);
                                m(i) = ns{i}.CI(50);
                                ci5 = ns{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                ...
                data1 = ms{i}.getProp(MRIMeasureBUD.VALUES1);
                data{i,REGIONMEASURES_MEAS_VALUE_COL} = data1(bri);
                
                data{i,REGIONMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(MRIMeasureBUD.THRESHOLD1);
                data{i,REGIONMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(MRIMeasureBUD.DENSITY);
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(MRIMeasureBUD.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(MRIMeasureBUD.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(MRIMeasureBUD.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(MRIMeasureBUD.PARAM);
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cs{i}.getProp(MRIComparisonBUD.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(MRIComparisonBUD.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cs{i}.getProp(MRIComparisonBUD.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(MRIComparisonBUD.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(MRIComparisonBUD.GROUP2);
            ...
            for i = 1:1:length(ns)
                ...
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{i}.getProp(MRIRandomComparisonBUD.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(MRIRandomComparisonBUD.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{i}.getProp(MRIRandomComparisonBUD.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{i}.getProp(MRIRandomComparisonBUD.GROUP1);
                ...
                if get(ui_checkbox_regionmeasures_meas,'Value')
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                meas1 = ms{i}.getProp(MRIMeasureBUD.VALUES1);
                                meas(i) = meas1(bri);
                                d(i) = ms{i}.getProp(MRIMeasureBUD.DENSITY);
                            end
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                ...
                                temp = ns{i}.getProp(MRIRandomComparisonBUD.RANDOM_COMP_VALUES);
                                meas(i) = temp(bri);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIMRIGraphAnalysisBUDViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIMRIGraphAnalysisBUDViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIMRIGraphAnalysisBUDViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIMRIGraphAnalysisBUDSetGraph(f,ga,bg)
    end
