% File to test the use of MRIComparisonBUD.
%
...
comparison = MRIComparisonBUD( ...
    MRIComparisonBUD.CODE,3, ...
    MRIComparisonBUD.NOTES,'Comparison BUD', ...
    MRIComparisonBUD.DENSITY,20, ...
    MRIComparisonBUD.GROUP1,1, ...
    MRIComparisonBUD.GROUP2,5)
