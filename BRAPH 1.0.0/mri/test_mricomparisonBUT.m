% File to test the use of MRIComparisonBUT.
%
...
comparison = MRIComparisonBUT( ...
    MRIComparisonBUT.CODE,3, ...
    MRIComparisonBUT.NOTES,'Comparison BUT', ...
    MRIComparisonBUT.THRESHOLD,0.2, ...
    MRIComparisonBUT.GROUP1,1, ...
    MRIComparisonBUT.GROUP2,5)
