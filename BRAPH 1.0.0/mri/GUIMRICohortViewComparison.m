function fig_comparison = GUIMRICohortViewComparison(fig_comparison,cohort,bg)
...
set(fig_comparison,'Name',[APPNAME ' : Comparison settings - ' BNC.VERSION ' - ' cohort.getProp(MRICohort.NAME)])
