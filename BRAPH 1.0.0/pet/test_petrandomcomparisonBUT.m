% File to test the use of PETRandomComparisonBUT.
%
...
%% create BUT random comparison

comparison = PETRandomComparisonBUT( ...
    PETComparisonBUT.CODE,3, ...
    PETComparisonBUT.NOTES,'Comparison BUT', ...
    PETComparisonBUT.THRESHOLD,0.2, ...
    PETComparisonBUT.GROUP1,1, ...
    PETComparisonBUT.GROUP2,5)
