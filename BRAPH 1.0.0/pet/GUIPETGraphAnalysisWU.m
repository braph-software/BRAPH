function GUIPETGraphAnalysisWU(ga)
%% PET Graph Analysis
...
%% General Constants
APPNAME = [GUI.PGA_NAME ' WU'];  % application name
BUILT = BNC.BUILT;
...
%% Application data
Check.isa('Error: The PET graph analysis ga must be a PETGraphAnalysisWU',ga,'PETGraphAnalysisWU')
selected_calc = [];
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = PETGraphAnalysisWU(PETCohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisWUCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisWUCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisWUCalcRand(ga,mlist,selected_calc)
    end
...
init_matrix()
    ...
    function S = update_rearrange()
        ...
        graph = GraphWU(ga.getA(group),'structure',ga.getStructure());
        [S,~] = graph.structure();
    end
...
init_brainmeasures_table()
    function init_brainmeasures_table()
        ...
        set(ui_popup_brainmeasures_comp_group2,'Position',[.13 .04 .10 .03])
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(indices)
                ...
                data{i,BRAINMEASURES_MEAS_VALUE_COL} = ms{indices(i)}.getProp(PETMeasureWU.VALUES1);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{indices(i)}.getProp(PETMeasureWU.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{indices(i)}.getProp(PETMeasureWU.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{indices(i)}.getProp(PETMeasureWU.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{indices(i)}.getProp(PETMeasureWU.GROUP1);
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            set(ui_table_brainmeasures,'ColumnFormat',{'logical','numeric','numeric','numeric','numeric','numeric','numeric','numeric','numeric','char','char','numeric','numeric','numeric'})
            ...
            for i = 1:1:length(indices)                
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cos{indices(i)}.getProp(PETComparisonWU.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cos{indices(i)}.getProp(PETComparisonWU.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cos{indices(i)}.getProp(PETComparisonWU.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cos{indices(i)}.getProp(PETComparisonWU.VALUES2);
                
                confint = cos{indices(i)}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cos{indices(i)}.getProp(PETComparisonWU.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cos{indices(i)}.getProp(PETComparisonWU.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cos{indices(i)}.getProp(PETComparisonWU.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cos{indices(i)}.getProp(PETComparisonWU.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cos{indices(i)}.getProp(PETComparisonWU.GROUP2);
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(indices)
                ...
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.VALUES1);
                
                confint = ns{indices(i)}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{indices(i)}.getProp(PETRandomComparisonWU.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.GROUP1);
...
init_regionmeasures()
    function init_regionmeasures()
        ...
        set(ui_popup_regionmeasures_comp_br,'Position',[.02 .04 .07 .03])
        ...
        set(ui_popup_regionmeasures_comp_group1,'Position',[.11 .04 .07 .03])
        ...
        set(ui_popup_regionmeasures_comp_group2,'Position',[.19 .04 .07 .03])
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            set(ui_table_regionmeasures,'ColumnName',{'',' value ',' notes ',' measure ',' group ',' brain region ',' param '})
            ...
            for i = 1:1:length(indices)
                ...
                data1 = ms{indices(i)}.getProp(PETMeasureWU.VALUES1);
                data{i,REGIONMEASURES_MEAS_VALUE_COL} = data1(bri);
                
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{indices(i)}.getProp(PETMeasureWU.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{indices(i)}.getProp(PETMeasureWU.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{indices(i)}.getProp(PETMeasureWU.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{indices(i)}.getProp(PETMeasureWU.PARAM);
                RowName(i) = mi(indices(i));
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(indices)
                ...
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cos{indices(i)}.getProp(PETComparisonWU.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cos{indices(i)}.getProp(PETComparisonWU.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cos{indices(i)}.getProp(PETComparisonWU.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cos{indices(i)}.getProp(PETComparisonWU.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cos{indices(i)}.getProp(PETComparisonWU.GROUP2);
        ...
        elseif get(ui_checkbox_regionmeasures_rand,'Value')
            ...
            for i = 1:1:length(indices)
                ...
                val = ns{indices(i)}.getProp(PETRandomComparisonWU.RANDOM_COMP_VALUES);
                data{i,REGIONMEASURES_RAND_COMPVALUE_COL} = val(bri);
                
                p1 = ns{indices(i)}.getProp(PETRandomComparisonWU.PVALUE1);
                data{i,REGIONMEASURES_RAND_PVALUE1_COL} = p1(bri);
                data{i,REGIONMEASURES_RAND_FDR1_COL} = fdr(p1);
                
                p2 = ns{indices(i)}.getProp(PETRandomComparisonWU.PVALUE2);
                data{i,REGIONMEASURES_RAND_PVALUE2_COL} = p2(bri);
                data{i,REGIONMEASURES_RAND_FDR2_COL} = fdr(p2);
                
                rval = ns{indices(i)}.getProp(PETRandomComparisonWU.VALUES1);
                ...
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{indices(i)}.getProp(PETRandomComparisonWU.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{indices(i)}.getProp(PETRandomComparisonWU.GROUP1);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisWUViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisWUViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisWUViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIPETGraphAnalysisWUSetGraph(f,ga,bg)
    end
