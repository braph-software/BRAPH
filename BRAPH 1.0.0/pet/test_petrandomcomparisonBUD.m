% File to test the use of PETRandomComparisonBUD.
%
...
comparison = PETRandomComparisonBUD( ...
    PETRandomComparisonBUD.CODE,3, ...
    PETRandomComparisonBUD.NOTES,'Comparison BUD', ...
