function GUIPETGraphAnalysisBUT(ga)
%% PET Graph Analysis
...
%% General Constants
APPNAME = [GUI.PGA_NAME ' BUT'];  % application name
BUILT = BNC.BUILT;
...
%% Application data
Check.isa('Error: The PET graph analysis ga must be a PETGraphAnalysisBUT',ga,'PETGraphAnalysisBUT')
selected_calc = [];
...
% Callbacks to manage application data
    ...
    function cb_import_xml(~,~)  % (scr,event)
        gatmp = PETGraphAnalysisBUT(PETCohort(BrainAtlas()),Structure());
...
setup_calc_corr()
    ...
    function cb_calc_view(~,~)  % (src,event)
    ...
    function cb_calc_calculate(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisBUTCalcMeas(ga,mlist,selected_calc)
    end
    function cb_calc_compare(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisBUTCalcComp(ga,mlist,selected_calc)
    end
    function cb_calc_random(~,~)  %  (src,event)
        mlist = measurelist();
        GUIPETGraphAnalysisBUTCalcRand(ga,mlist,selected_calc)
    end
    ...
    function update_brainmeasures_table()
        ...
        if get(ui_checkbox_brainmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                ...
                data{i,BRAINMEASURES_MEAS_VALUE_COL} = ms{i}.getProp(PETMeasureBUT.VALUES1);
                data{i,BRAINMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(PETMeasureBUT.THRESHOLD);
                data{i,BRAINMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(PETMeasureBUT.DENSITY1);
                data{i,BRAINMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(PETMeasureBUT.NOTES);
                data{i,BRAINMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(PETMeasureBUT.CODE)};
                data{i,BRAINMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(PETMeasureBUT.PARAM);
                data{i,BRAINMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(PETMeasureBUT.GROUP1);
            end
        ...
        elseif get(ui_checkbox_brainmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,BRAINMEASURES_COMP_PVALUE1_COL} = cs{i}.getProp(PETComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_COMP_PVALUE2_COL} = cs{i}.getProp(PETComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_COMP_VALUE1_COL} = cs{i}.getProp(PETComparisonBUT.VALUES1);
                data{i,BRAINMEASURES_COMP_VALUE2_COL} = cs{i}.getProp(PETComparisonBUT.VALUES2);
                
                confint = cs{i}.CI(5);
                data{i,BRAINMEASURES_COMP_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_COMP_CIU_COL} = confint(2);
                
                threshold = cs{i}.getProp(PETComparisonBUT.THRESHOLD);
                data{i,BRAINMEASURES_COMP_THRESHOLD_COL} = threshold;
                
                density1 = cs{i}.getProp(PETComparisonBUT.DENSITY1);
                density2 = cs{i}.getProp(PETComparisonBUT.DENSITY2);
                data{i,BRAINMEASURES_COMP_DENSITY1_COL} = density1;
                data{i,BRAINMEASURES_COMP_DENSITY2_COL} = density2;
                
                data{i,BRAINMEASURES_COMP_NOTES_COL} = cs{i}.getProp(PETComparisonBUT.NOTES);
                data{i,BRAINMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(PETComparisonBUT.CODE)};
                data{i,BRAINMEASURES_COMP_PARAM_COL} = cs{i}.getProp(PETComparisonBUT.PARAM);
                data{i,BRAINMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(PETComparisonBUT.GROUP1);
                data{i,BRAINMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(PETComparisonBUT.GROUP2);
            end
            set(ui_table_brainmeasures,'Data',data)
        ...
        elseif get(ui_checkbox_brainmeasures_rand,'Value')
            ...
            for i = 1:1:length(ns)
                ...
                data{i,BRAINMEASURES_RAND_COMPVALUE_COL} = ns{i}.getProp(PETRandomComparisonBUT.RANDOM_COMP_VALUES);
                data{i,BRAINMEASURES_RAND_PVALUE1_COL} = ns{i}.getProp(PETRandomComparisonBUT.PVALUE1);
                data{i,BRAINMEASURES_RAND_PVALUE2_COL} = ns{i}.getProp(PETRandomComparisonBUT.PVALUE2);
                data{i,BRAINMEASURES_RAND_REALVALUE_COL} = ns{i}.getProp(PETRandomComparisonBUT.VALUES1);
                
                confint = ns{i}.CI(5);
                data{i,BRAINMEASURES_RAND_CIL_COL} = confint(1);
                data{i,BRAINMEASURES_RAND_CIU_COL} = confint(2);
                
                threshold = ns{i}.getProp(PETRandomComparisonBUT.THRESHOLD);
                data{i,BRAINMEASURES_RAND_THRESHOLD_COL} = threshold;
                
                density = ns{i}.getProp(PETRandomComparisonBUT.DENSITY1);
                data{i,BRAINMEASURES_RAND_DENSITY_COL} = density;
                
                data{i,BRAINMEASURES_RAND_NOTES_COL} = ns{i}.getProp(PETRandomComparisonBUT.NOTES);
                data{i,BRAINMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(PETRandomComparisonBUT.CODE)};
                data{i,BRAINMEASURES_RAND_PARAM_COL} = ns{i}.getProp(PETRandomComparisonBUT.PARAM);
                data{i,BRAINMEASURES_RAND_GROUP_COL} = ns{i}.getProp(PETRandomComparisonBUT.GROUP1);
            end
                ...
                if get(ui_checkbox_brainmeasures_meas,'Value')
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                meas(i) = ms{i}.getProp(PETMeasureBUT.VALUES1);
                                d(i) = ms{i}.getProp(PETMeasureBUT.THRESHOLD);
                            end
                ...
                elseif get(ui_checkbox_brainmeasures_comp,'Value')
                    ...
                    if ~isempty(ci)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(cs)
                                diff(i) = cs{i}.diff();
                                d(i) = cs{i}.getProp(PETMeasureBUT.THRESHOLD);
                                m(i) = cs{i}.CI(50);
                                ci5 = cs{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
                ...
                elseif get(ui_checkbox_brainmeasures_rand,'Value')
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                meas(i) = ns{i}.getProp(PETRandomComparisonBUT.RANDOM_COMP_VALUES);
                                d(i) = ns{i}.getProp(PETRandomComparisonBUT.THRESHOLD);
                                m(i) = ns{i}.CI(50);
                                ci5 = ns{i}.CI(5);
                                ci5l(i) = ci5(1);
                                ci5u(i) = ci5(2);
    ...
    function update_regionmeasures_table()
        ...
        if get(ui_checkbox_regionmeasures_meas,'Value')
            ...
            for i = 1:1:length(ms)
                ...
                data1 = ms{i}.getProp(PETMeasureBUT.VALUES1);
                data{i,REGIONMEASURES_MEAS_VALUE_COL} = data1(bri);
                
                data{i,REGIONMEASURES_MEAS_THRESHOLD_COL} = ms{i}.getProp(PETMeasureBUT.THRESHOLD);
                data{i,REGIONMEASURES_MEAS_DENSITY_COL} = ms{i}.getProp(PETMeasureBUT.DENSITY1);
                data{i,REGIONMEASURES_MEAS_NOTES_COL} = ms{i}.getProp(PETMeasureBUT.NOTES);
                data{i,REGIONMEASURES_MEAS_MEASURE_COL} = Graph.NAME{ms{i}.getProp(PETMeasureBUT.CODE)};
                data{i,REGIONMEASURES_MEAS_GROUP_COL} = ms{i}.getProp(PETMeasureBUT.GROUP1);
                data{i,REGIONMEASURES_MEAS_BR_COL} = BrainRegions{bri};
                data{i,REGIONMEASURES_MEAS_PARAM_COL} = ms{i}.getProp(PETMeasureBUT.PARAM);
            end
        ...
        elseif get(ui_checkbox_regionmeasures_comp,'Value')
            ...
            for i = 1:1:length(cs)
                ...
                data{i,REGIONMEASURES_COMP_NOTES_COL} = cs{i}.getProp(PETComparisonBUT.NOTES);
                data{i,REGIONMEASURES_COMP_MEASURE_COL} = Graph.NAME{cs{i}.getProp(PETComparisonBUT.CODE)};
                data{i,REGIONMEASURES_COMP_PARAM_COL} = cs{i}.getProp(PETComparisonBUT.PARAM);
                data{i,REGIONMEASURES_COMP_GROUP1_COL} = cs{i}.getProp(PETComparisonBUT.GROUP1);
                data{i,REGIONMEASURES_COMP_GROUP2_COL} = cs{i}.getProp(PETComparisonBUT.GROUP2);
            ...
            for i = 1:1:length(ns)
                ...
                data{i,REGIONMEASURES_RAND_NOTES_COL} = ns{i}.getProp(PETRandomComparisonBUT.NOTES);
                data{i,REGIONMEASURES_RAND_MEASURE_COL} = Graph.NAME{ns{i}.getProp(PETRandomComparisonBUT.CODE)};
                data{i,REGIONMEASURES_RAND_PARAM_COL} = ns{i}.getProp(PETRandomComparisonBUT.PARAM);
                data{i,REGIONMEASURES_RAND_GROUP_COL} = ns{i}.getProp(PETRandomComparisonBUT.GROUP1);
                ...
                if get(ui_checkbox_regionmeasures_meas,'Value')
                    ...
                    if ~isempty(mi)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ms)
                                meas1 = ms{i}.getProp(PETMeasureBUT.VALUES1);
                                meas(i) = meas1(bri);
                                d(i) = ms{i}.getProp(PETMeasureBUT.THRESHOLD);
                            end
                    ...
                    if ~isempty(ni)
                        ...
                        if isempty(strmatch(name,str2))
                            ...
                            for i = 1:1:length(ns)
                                ...
                                temp = ns{i}.getProp(PETRandomComparisonBUT.RANDOM_COMP_VALUES);
                                meas(i) = temp(bri);
...
init_brainview()
    ...
    function cb_brainview_viewgroup(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisBUTViewMeas(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewcomparison(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisBUTViewComp(fig_group,ga,bg)
        else
    ...
    function cb_brainview_viewrandom(~,~)  % (src,event)
        ...
        if ga.getCohort().length()>0
            GUIPETGraphAnalysisBUTViewRand(fig_group,ga,bg)
        else
    ...
    function cb_brainview_graph(~,~)  % (src,event)
        ...
        GUIPETGraphAnalysisBUTSetGraph(f,ga,bg)
    end
