% File to test the use of clustering coefficient measure of a weighted undirected graph.
%
...
N = graph.nodenumber();
[a,b] = graph.cluster();
disp('clustering coefficient of nodes:')
disp(b)
disp('clustering coefficient of graph:')
disp(a)
