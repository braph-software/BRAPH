% File to test the use of closeness measure of a weighted directed graph.
%
...
%% Create Graph and Calculate Closeness
...
graph = GraphWD(A);
N = graph.nodenumber();
[a,b,c] = graph.closeness();
disp('Closeness of nodes:')
disp(a)
disp('In-closeness of nodes:')
disp(b)
disp('out-closeness of nodes:')
disp(c)
