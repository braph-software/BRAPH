% File to test the use of global efficiency measure of a binary directed graph.
%
...
if  isequal(gin,geff_in) && isequal(gout,geff_out) && isequal(g,geff)
    disp('Bindary directed global efficiency calculated correctly')
else
    errordlg('Bindary directed global efficiency NOT correct')
end